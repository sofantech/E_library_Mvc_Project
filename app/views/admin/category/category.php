...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Category /</span> CRUD
</h4>
...
<div class="offcanvas offcanvas-end" id="add-new-record">
  ...
  <div class="offcanvas-body flex-grow-1">
    <form class="add-new-record pt-0 row g-2" id="form-add-new-record" >
      <div class="col-sm-12">
        <label class="form-label" for="basicFullname">Category Name</label>
        <div class="input-group input-group-merge">
          <span id="basicFullname2" class="input-group-text"><i class="bx bx-user"></i></span>
          <input type="text" id="basicFullname" class="form-control dt-full-name" name="basicFullname" placeholder="category name" aria-label="John Doe" aria-describedby="basicFullname2" />
        </div>
      </div>
      <div class="col-sm-12">
      ...
      <div class="col-sm-12">
        <label class="form-label" for="basicEmail">Created By</label>
        <div class="input-group input-group-merge">
      ...
      <div class="col-sm-12">
        <label class="form-label" for="basicDate">Created At</label>
        <div class="input-group input-group-merge">
